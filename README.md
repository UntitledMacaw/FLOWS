...
> A lightweight, fast flood-risk estimation approach designed to run on modest hardware — using a topology-based basins pre-compilation instead of full hydrodynamic simulation.
